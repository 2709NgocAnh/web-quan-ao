        ...
        <header className={cx('wrapper')}>
            <div className={cx('inner')}>
                ...
                <div className={toggle ? 'toggle' : ''}>
                    <Menu>
                        <MenuItem className={cx('menulink')} title="Shop" to={config.routes.shop} />
                        <MenuItem className={cx('menulink')} title="News" to={config.routes.news} />
                        <MenuItem className={cx('menulink')} title="About" to={config.routes.about} />
                        <MenuItem className={cx('menulink')} title="Sale" to={config.routes.sale} />
                        <MenuItem className={cx('menulink')} title="Contact" to={config.routes.contact} />
                        <li className={cx('close')} onClick={() => setToggle('true')}>
