...
import Meniu from './svg/bars-solid.svg';
        ...
        <header className={cx('wrapper')}>
            <div className={cx('inner')}>
                ...
                <div className={toggle ? 'toggle' : ''}>
                    <Menu>
                        <MenuItem className={cx('menu')} title="Shop" to={config.routes.shop} />
                        <MenuItem className={cx('menu')} title="News" to={config.routes.news} />
                        <MenuItem className={cx('menu')} title="About" to={config.routes.about} />
                        <MenuItem className={cx('menu')} title="Sale" to={config.routes.sale} />
                        <MenuItem className={cx('menu')} title="Contact" to={config.routes.contact} />
                        <li className="close" onClick={() => setToggle('true')}>
