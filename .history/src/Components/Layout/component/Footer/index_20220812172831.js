                    ...
                    <div className={cx('col-xs-12 col-sm-6 col-md-4 col-lg')}>
                        <div className={cx('footer-col footer-content1')}>
                            ...
                            <div className={cx('footer-content')}>
                                <p className={cx('footer-content-title')}>Hi.</p>
                                ...
                                <div className={cx('logo-footer')}>
                                    <a href="/" target="_blank" rel="nofollow noreferrer">
                                        <img
                                            ...
                                            alt="Bộ Công Thương"
                                        />
                                        <p className={cx('footer-content-title')}>
                                            Chi Nhánh Hồ Chí Minh Quận 10 - 561 Sư Vạn Hạnh, Phường 13. Quận Tân Bình -
                                            136 Nguyễn Hồng Đào, Phường 14. Quận 1 - The New Playground 26 Lý Tự Trọng,
                                            Phường Bến Nghé. Quận 1 - Central Market 4 Phạm Ngũ Lão, Phường Phạm Ngũ
                                            Lão. Quận Gò Vấp - 41 Quang Trung, Phường 3. Chi Nhánh Biên Hòa: TP.Biên Hòa
