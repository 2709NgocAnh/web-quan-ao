                                ...
                                <div className={cx('logo-footer')}>
                                    <a href="/" target="_blank" rel="nofollow noreferrer">
                                        ...
                                        <p className={cx('footer-content-title')}>
                                            ...
                                            <li>- Quận Tân Bình - 136 Nguyễn Hồng Đào, Phường 14. Quận 1 </li>
                                            <li>- The New Playground 26 Lý Tự Trọn Phường Bến Nghé. Quận 1 </li>
                                            <li> - Central Market 4 Phạm Ngũ Lão, Phường Phạm Ngũ Lão.</li>
                                            <li>- Quận Gò Vấp - 41 Quang Trung, Phường 3.</li>
                                        </p>
                                    </a>
                                </div>
                            </div>
